...
　　
### 著作権表記  
本家の README には、松村哲理・増田茂などの名前が上がっているのですが、疑問に思うところ（PR や merge の痕跡がいっさいない、[ネット上の増田茂医師の言動がとても臨床医とは思えない](https://p-horlix.net/blog/?p=811)）があって LSC に問い合わせたところ「クレジットするには及ばない」とのことでした。  
...
かいつまんでいうと不適切な著作権表示を盾に「OpenDolphin-2.7 は皆川和史の個人著作だ。皆川をクレジットしていないプロダクトは全て GPL 違反だ」という主張です。  
OpenDolphin は e-dolphin 時代よりいわゆる職務著作として開発が継続されており、基本設計も e-dolphin 時代になされています。2.7 系は、e-dolphin 時代の基本設計の上に LSC がモダンなクライアント・サーバシステムに仕立て上げたという特徴があり、上記の主張はとても受け入れ難いものです。  
